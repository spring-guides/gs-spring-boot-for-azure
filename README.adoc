...
== Run with AZD
You can also use (https://learn.microsoft.com/azure/developer/azure-developer-cli/overview)[the Azure Developer CLI (azd)] to get you up and running this application on Azure Spring Apps quickly. Azure Developer CLI is an open-source tool that accelerates the time it takes for you to get your application from local development environment to Azure.
