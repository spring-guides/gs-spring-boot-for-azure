...
* https://docs.microsoft.com/azure/developer/java/spring-framework/getting-started-with-spring-cloud-function-in-azure [Deploy your Spring Boot app to Azure Functions]
